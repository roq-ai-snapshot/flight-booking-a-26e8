...
import { usePassengerFindFirst, useRoqClient } from 'lib/roq';
...
function PassengerViewPage() {
  ...
  const { data, error, isLoading } = usePassengerFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('passenger', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/passengers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Passport Number" text={data?.passport_number} />
