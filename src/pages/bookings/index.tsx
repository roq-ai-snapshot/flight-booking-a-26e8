...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['flight', 'user', 'passenger.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['booking_code.contains', 'seat_number.contains'],
          ...params.filters,
        },
        'booking',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'booking_code', header: 'Booking Code', accessorKey: 'booking_code' },
    { id: 'seat_number', header: 'Seat Number', accessorKey: 'seat_number' },
    {
      id: 'booking_date',
      header: 'Booking Date',
    ...
    hasAccess('passenger', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.passenger,
        }
      : null,
